SERVICE = msneddoncontigfilterperl
SERVICE_CAPS = MSneddonContigFilterPerl
SPEC_FILE = MSneddonContigFilterPerl.spec
URL = https://kbase.us/services/msneddoncontigfilterperl
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
