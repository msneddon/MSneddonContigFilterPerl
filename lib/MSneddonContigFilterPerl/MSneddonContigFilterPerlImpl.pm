package MSneddonContigFilterPerl::MSneddonContigFilterPerlImpl;
use strict;
...
sub new
{
    ...
    my $wsInstance = $cfg->val('MSneddonContigFilterPerl','workspace-url');
...
sub filter_contigs
{
    ...
    my $ctx = $MSneddonContigFilterPerl::MSneddonContigFilterPerlServer::CallContext;
    my($return);
